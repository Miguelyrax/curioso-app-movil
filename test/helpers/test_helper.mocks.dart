...
import 'package:curioso_app/core/error/failure.dart' as _i7;
import 'package:curioso_app/features/quiz/domain/entities/quiz.dart' as _i8;
...
class MockQuizRepository extends _i1.Mock implements _i5.QuizRepository {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.Quiz>> getCurrentWeather(
          String? cityName) =>
      (super.noSuchMethod(Invocation.method(#getQuiz, [cityName]),
              returnValue: Future<_i2.Either<_i7.Failure, _i8.Quiz>>.value(
                  _FakeEither_0<_i7.Failure, _i8.Quiz>()))
          as _i6.Future<_i2.Either<_i7.Failure, _i8.Quiz>>);
  @override
